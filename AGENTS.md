...
本文件只规定仓库内通用协作方式，不承载项目架构、市场规则、算法公式、求解器选择或模块归属。当前代码事实、未完成闭环和下一开发路线统一见 `docs/策略算法框架详细设计-v6.md` 的 §2、§6、§8、§9；v3 为已批准架构决策，v0～v2、v4 与 v5 为历史溯源。
...
- `docs/策略算法框架详细设计-v6.md` 是唯一在研设计、当前事实快照和下一开发路线；其中标记为“待评审/待决策”的内容不构成实施授权。
