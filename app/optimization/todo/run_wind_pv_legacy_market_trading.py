...
if str(APP_ROOT / "legacy") not in sys.path:
    sys.path.insert(0, str(APP_ROOT / "legacy"))
...
CONFIG_PATH = PROJECT_ROOT / 'configs' / 'optimization' / 'todo' / 'wind_pv_legacy_market_trading.yaml'
