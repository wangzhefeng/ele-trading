...
从 configs/wind_simulation_v2.yaml 加载参数，
...
DEFAULT_CONFIG_PATH = PROJECT_ROOT / 'configs' / 'wind_simulation_v2.yaml'
...
def run_wind_simulation_v2(config: dict[str, Any]) -> pd.DataFrame:
    ...
    df = result.output_mw.rename("wind_power_mw").to_frame().reset_index()
