    ...
    result_df = pd.DataFrame(
        {
            ...
            "pv_to_load": result.renewable_to_load,
            "pv_to_bess": result.renewable_to_bess,
            "pv_to_grid": result.renewable_to_grid,
            "pv_curtailment": result.renewable_curtailment,
