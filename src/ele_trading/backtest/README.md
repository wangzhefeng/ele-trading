...
当前回测主要证明样例链路、无前瞻边界和回归一致性，不证明生产策略收益。业务反例和统一验收框架已存在；archived-vintage、真实账单、影子运行、统计晋级和回滚仍是 [v5 §12、V5-11](../../../docs/策略算法框架详细设计-v5.md#146-v5-11经济验收影子运行与默认晋级) 的未完成工作。
