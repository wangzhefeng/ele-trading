...
def run_user_side_wind_bess_distributed_dispatch(
        ...
        DistributedRenewableBESSDispatchInput(
            ...
            nodes=[
                DistributedRenewableBESSNodeInput(
                    ...
                    renewable_forecast=node.wind_forecast,
    ...
    return DistributedWindBESSDispatchResult(
        wind_to_load_by_node=renewable_result.renewable_to_load_by_node,
        wind_to_bess_by_node=renewable_result.renewable_to_bess_by_node,
        wind_to_grid_by_node=renewable_result.renewable_to_grid_by_node,
        wind_curtailment_by_node=renewable_result.renewable_curtailment_by_node,
