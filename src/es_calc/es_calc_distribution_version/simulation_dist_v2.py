...
from src.es_calc.es_calc_distribution_version.optimization_optim_dist_v2 import (
...
def simulate_schedule(
    ...
    return SimulationResult(
        ...
        equal_cabinet_violation_count=equal_cabinet_violation_count,
...
def plot_strategy_power_detail(
    ...
    """绘制 dist v2 模型的系统负荷、储能出力、电价背景和月最大需量线。"""
    ...
    strategy_name = strategy_dir or f"es_scale_experiment_optim_dist_{system_name}-v2"
    ...
    fig.suptitle(
        f"{exp_name}/{node_name}/{system_name} - dist v2 strategy {selected_combo_key} - {label_suffix}",
        fontsize=14,
    )
...
if __name__ == "__main__":
    ...
    for system_name in selected_systems:
        strategy_dir = f"es_scale_experiment_optim_dist_{system_name}-v2"
    ...
    if args.system == "338":
        for combo_key in [
            "338_1-1__338_2-1__338_3-1",
            "338_1-2__338_2-2__338_3-2",
            "338_1-3__338_2-3__338_3-3",
            "338_1-4__338_2-4__338_3-4",
            "338_1-5__338_2-5__338_3-5",
            "338_1-6__338_2-6__338_3-6",
            "338_1-7__338_2-7__338_3-7",
            "338_1-8__338_2-8__338_3-8",
            "338_1-9__338_2-9__338_3-9",
            "338_1-10__338_2-10__338_3-10",
        ]:
