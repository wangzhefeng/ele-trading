...
def one_process(
    es_scale, node_name, max_demand_price, start_time, end_time, exp_name, freq_minutes
):
    # params
    devices_info = [
        {
    ...
    for time_pair in validation_day_list:
        ...
        scheduler_model = EsArbitraryRangeScheduler_withoutDemand(
...
if __name__ == "__main__":
    ...
    freq_minutes = 15
    es_scale_list = list(range(900, 1450, 50))
    ...
    for result_i in mp_result_list:
        ...
        result_i[2].to_csv(
            f"./data/{exp_name}/{node_name}/opt_result/es_scale_experiment_optim_withoutDemand/schedule_result_scale_10_{es_scale}.csv"
        )
