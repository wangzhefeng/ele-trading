...
# 测试代码 main 函数
def main():
    validation_day_list = generate_hourly_datetime_pairs(year=2025, month=5, hour=22)
    for day in validation_day_list:
        print(day)
    
    first_day, next_month_first_day = get_month_range(month=5, year=2025)
    print(first_day)
