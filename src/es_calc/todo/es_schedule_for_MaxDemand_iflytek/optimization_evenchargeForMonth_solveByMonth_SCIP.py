...
class EsArbitraryRangeScheduler_withMaxDemand:
    ...
    def modeling2solving(self):
        ...
        # 目标函数
        profit = time_ratio * (e_c_in_agg_vec + e_c_out_agg_vec) @ p + self.max_demand_price * cp.min(e_c_in_agg_vec)
...
def one_process(es_scale, route_num_str):
    devices_info = [{"usable_depth": 0.9,
                    ...
                    "es_capacity_min": 0}]
    # devices_info = [{"usable_depth": 0.90,
    #                 "charge_loss": 0.92,
    #                 "discharge_loss": 0.95,
    #                 "es_charge_max": es_scale,
    #                 "es_charge_min": -es_scale,
    ...
    result_df.to_csv(f"./data/{exp_name}/{node_name}/opt_result/es_scale_experiment_evencharge/schedule_result_scale_{es_scale}.csv")
...
if __name__ == '__main__':
    ...
    es_scale_list = list(range(625, 700, 500))
    route_list = ["10"]
