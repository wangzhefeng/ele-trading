...
def one_process(devices_info, route_num_str, month, exp_name):
    ...
    return devices_info[0]["es_charge_max"], node_name, result_df
...
if __name__ == '__main__':
    ...
    for result_i in mp_result_list:
        ...
        result_dir = Path(f"./data/{exp_name}/{node_name}/opt_result/es_scale_experiment_basic/")
