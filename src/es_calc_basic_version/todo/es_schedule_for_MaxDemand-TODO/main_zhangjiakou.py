...
from models.EsArbitraryRangeScheduler_withMaxDemand_basic import EsArbitraryRangeScheduler_withMaxDemand
...
def scheduler(exp_name, node_name, demand_load_df, ele_price_df, devices_info, 
              demand_break_ratio, data_dir, save_range_start, save_range_end,
              demand_load_by_day: bool=True):
    # 时间区间
...
def run_scheduler(exp_name, node_name, demand_load_df, ele_price_df, devices_info, 
                  demand_break_ratios, data_dir, save_range_start, save_range_end, 
                  demand_load_by_day: bool=True):
    # simulation
    mp_input_list = [(
        exp_name, node_name, demand_load_df, ele_price_df, 
        devices_info, demand_break_ratio, data_dir, 
        save_range_start, save_range_end,
        demand_load_by_day, 
...
def main():
    ...
    devices_info = [{
        ...
        "es_charge_max": 17840,
        "es_charge_min": -17840,
        "es_capacity_max": 35776,
        "es_capacity_min": 0,
    }]
    # simulation info
    es_info = {
        "transform_capacity": 80000,
        "invertband": 0,
    ...
    for node_name in node_names:
        ...
        run_scheduler(
            ...
            data_dir = data_dir,
            save_range_start = save_range_start, 
            save_range_end = save_range_end, 
    ...
    if len(node_names) == 2:
        ...
        revenue_results["revenue_total"] = revenue_results["revenue_A"]
