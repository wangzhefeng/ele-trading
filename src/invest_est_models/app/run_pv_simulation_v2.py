...
from invest_est_models.resource_simulation import PVSimulator, fetch_weather_open_meteo, load_weather_csv
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run invest_est_models PV simulation v2.")
