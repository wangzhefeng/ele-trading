...
from investment_estimation.resource_simulation import WindSimulator, SimulationResult
from investment_estimation.utils.io import read_yaml
from investment_estimation.utils.log_util import logger

CONFIG_PATH = PACKAGE_ROOT / 'configs' / 'capacity_planning' / 'wind_bess_capacity_planning.yaml'
...
def main():
    ...
    shift_policy = ShiftPolicy(
        ...
        shift_max_frac_of_resource=shift_cfg.get('shift_max_frac_of_wind', 0.30),
    )
