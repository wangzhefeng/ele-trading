...
> **迁移说明**（2026-07）：本 PLAN 原为 `src/ele_trading/capacity_planning/PLAN.md`，现已随老版 capacity_planning 整体迁入 `investment_estimation/todo/`。文中 `capacity_planning` 路径均指本目录；当前定位是**待整合暂存区**，后续与 `investment_estimation` 新版模块合并去重。
