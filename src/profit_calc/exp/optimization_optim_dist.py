...
from models.optimization.EsArbitraryRangeScheduler_withMaxDemand_optim_dist import (
...
TRANSFORMERS = [
    ...
    TransformerConfig("342_1", "demand_load_342_1.csv", 1250.0, 10),
    TransformerConfig("342_2", "demand_load_342_2.csv", 1250.0, 10),
]
