...
class EsArbitraryRangeScheduler_withMaxDemand:
    ...
    def modeling2solving(self):
        ...
        time_ratio = self.freq_minute / 60
...
def one_process(es_scale, route_num_str):
    ...
    end_time = datetime(2024, 12, 31, 23, 0, 0)
...
if __name__ == '__main__':
    ...
    es_scale_list = list(range(9000, 23000, 1000))
    route_list = ["A", "B"]
