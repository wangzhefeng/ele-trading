...
def one_process(es_scale, route_num_str):
    ...
    save_range_start = datetime(2024, 7, 1, 0, 0, 0)
    save_range_end = datetime(2025, 7, 1, 0, 0, 0)
    ...
    strategy_df = pd.read_csv(f"./data/{exp_name}/{node_name}/opt_result/es_scale_experiment_evencharge/schedule_result_scale_{es_scale}.csv")
...
if __name__ == '__main__':
    ...
    for k,v in result_df_dict.items():
        v.to_csv(f"./data/{exp_name}/{k}/opt_result/estimate_evencharge_result_scale_all.csv")
