...
def one_process(es_scale, route_num_str):
    ...
    strategy_df = pd.read_csv(f"./data/{exp_name}/{node_name}/opt_result/es_scale_experiment/schedule_result_scale_{es_scale}_online_True.csv")
...
if __name__ == '__main__':
    ...
    for k,v in result_df_dict.items():
        v.to_csv(f"./data/{exp_name}/{k}/opt_result/estimate_result_scale_all_online_True.csv")
