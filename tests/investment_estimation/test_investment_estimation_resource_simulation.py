...
from investment_estimation.app.build_resource_profile import build_resource_profile_from_paths
from investment_estimation.resource_simulation import PVProfileConfig, SimulationResult, load_or_build_pv_profile
from investment_estimation.resource_simulation.weather import fetch_weather_open_meteo
from investment_estimation.resource_simulation.wind_simulation_v1 import (
    WindProfileConfig,
...
def test_fetch_weather_open_meteo_uses_requests_without_network(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("investment_estimation.resource_simulation.weather.requests.get", fake_get)
