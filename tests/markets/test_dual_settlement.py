"""Unit tests for dual-settlement (band-deviation) formulas.

迁移自 v1 归档测试（公式零改动，仅 import 路径更新）。
"""
...
from ele_trading.markets.dual_settlement.settlement import (
...
class TestSettlePeriodsAggregation:
    """结算时段折算：96 点决策量聚合到 settle_periods 点后总量守恒。"""
