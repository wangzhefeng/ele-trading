...
from ele_trading.data_provider.todo.cvxp_bess_sample import build_cvxp_bess_dispatch_input
from ele_trading.optimization.todo.user_side_bess_dispatch_cvxpy import (
    CvxpBESSDispatcher,
...
def test_data_provider_package_exports_cvxp_builders_without_stale_loader():
    ...
    import ele_trading.data_provider.todo as data_provider
...
def test_cvxp_result_power_outputs_are_non_negative_business_values():
    ...
    config = read_yaml("configs/optimization/todo/cvxp_bess_dispatch.yaml")
