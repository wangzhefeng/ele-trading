...
from ele_trading.user_side_dispatch.cvxp_bess_sample import build_cvxp_bess_dispatch_input
...
def test_data_provider_package_exports_cvxp_builders_without_stale_loader():
    ...
    import ele_trading.user_side_dispatch as data_provider
...
def test_cvxp_result_power_outputs_are_non_negative_business_values():
    ...
    config = read_yaml("configs/user_side_dispatch/cvxp_bess_dispatch.yaml")
